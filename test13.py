...
GAIN = 1
RL = 20.2   # Your sensor's load resistor value in kΩ (check the SMD resistor)
R0 = 34.0   # Calibrated resistance in clean air (in kΩ)
a = -2.769
b = 2.602

def get_voltage(channel=0):
    value = adc.read_adc(channel, gain=GAIN)
    voltage = value * 4.096 / 32767  # ADS1115 full-scale voltage
    return voltage
